...
# VENDORED, UNMODIFIED METRIC LOGIC, from
# https://github.com/ymy-k/Hi-SAM/tree/main/hiertext_eval
# (originally google-research-datasets/hiertext).
#
# Sole change: apache_beam is imported lazily. It is used only by main() to run
# a parallel map over images - none of the metric functions touch it - and it is
# a very large dependency to install for that. run_hiertext_eval.py calls the
# same functions serially and produces identical numbers.
